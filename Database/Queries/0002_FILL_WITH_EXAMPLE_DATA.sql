...
INSERT INTO [Part] (Make, ModelName, Price, QuantityInStock, PartTypeId, PartAttributeId, ShopAssistantId) VALUES('SwiftZPart', 'E-500 F', 79.99, 10, 2, 2, 1);
INSERT INTO [Part] (Make, ModelName, Price, QuantityInStock, PartTypeId, PartAttributeId, ShopAssistantId) VALUES('SwiftZPart', 'E-500 R', 79.99, 10, 3, 1, 1);
INSERT INTO [Part] (Make, ModelName, Price, QuantityInStock, PartTypeId, PartAttributeId, ShopAssistantId) VALUES('PFB', 'E-500', 139.99, 2, 4, 1, 1);
INSERT INTO [Part] (Make, ModelName, Price, QuantityInStock, PartTypeId, PartAttributeId, ShopAssistantId) VALUES('SwiftZPart', 'E-500 CS', 109.99, 5, 8, 3, 1);
INSERT INTO [Part] (Make, ModelName, Price, QuantityInStock, PartTypeId, PartAttributeId, ShopAssistantId) VALUES('SwiftZPart', 'Bumpy', 159.99, 20, 1, 1, 1);
INSERT INTO [Part] (Make, ModelName, Price, QuantityInStock, PartTypeId, PartAttributeId, ShopAssistantId) VALUES('ClunkyJ', 'a8', 159.99, 20, 9, 1, 1);
INSERT INTO [Part] (Make, ModelName, Price, QuantityInStock, PartTypeId, PartAttributeId, ShopAssistantId) VALUES('SwiftZPart', 'E-500 C', 89.99, 40, 5, 1, 1);
INSERT INTO [Part] (Make, ModelName, Price, QuantityInStock, PartTypeId, PartAttributeId, ShopAssistantId) VALUES('SwiftZPart', 'E-500 FS', 159.99, 20, 6, 2, 1);
INSERT INTO [Part] (Make, ModelName, Price, QuantityInStock, PartTypeId, PartAttributeId, ShopAssistantId) VALUES('SwiftZPart', 'E-500 RS', 159.99, 20, 7, 1, 1);
